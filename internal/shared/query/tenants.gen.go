...
func newTenant(db *gorm.DB, opts ...gen.DOOption) tenant {
	...
	_tenant.tenantDo.UseModel(&po.Tenant{})

	tableName := _tenant.tenantDo.TableName()
	_tenant.ALL = field.NewAsterisk(tableName)
	_tenant.ID = field.NewInt64(tableName, "id")
	_tenant.UUID = field.NewString(tableName, "uuid")
	_tenant.Name = field.NewString(tableName, "name")
	_tenant.Slug = field.NewString(tableName, "slug")
	_tenant.Plan = field.NewString(tableName, "plan")
	_tenant.Status = field.NewString(tableName, "status")
	_tenant.Settings = field.NewString(tableName, "settings")
...
func (t *tenant) updateTableName(table string) *tenant {
	...
	t.Plan = field.NewString(table, "plan")
	t.Status = field.NewString(table, "status")
	t.Settings = field.NewString(table, "settings")
...
func (t *tenant) fillFieldMap() {
	...
	t.fieldMap["plan"] = t.Plan
	t.fieldMap["status"] = t.Status
	t.fieldMap["settings"] = t.Settings
...
type ITenantDo interface {
	...
	Unscoped() ITenantDo
	Create(values ...*po.Tenant) error
	CreateInBatches(values []*po.Tenant, batchSize int) error
	Save(values ...*po.Tenant) error
	First() (*po.Tenant, error)
	Take() (*po.Tenant, error)
	Last() (*po.Tenant, error)
	Find() ([]*po.Tenant, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Tenant, err error)
	FindInBatches(result *[]*po.Tenant, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po.Tenant) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po.Tenant, error)
	FirstOrCreate() (*po.Tenant, error)
	FindByPage(offset int, limit int) (result []*po.Tenant, count int64, err error)
...
func (t tenantDo) Create(values ...*po.Tenant) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tenantDo) CreateInBatches(values []*po.Tenant, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tenantDo) Save(values ...*po.Tenant) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tenantDo) First() (*po.Tenant, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po.Tenant), nil
	}
}

func (t tenantDo) Take() (*po.Tenant, error) {
...
func (t tenantDo) Last() (*po.Tenant, error) {
...
func (t tenantDo) Find() ([]*po.Tenant, error) {
	result, err := t.DO.Find()
	return result.([]*po.Tenant), err
}

func (t tenantDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Tenant, err error) {
	buf := make([]*po.Tenant, 0, batchSize)
...
func (t tenantDo) FindInBatches(result *[]*po.Tenant, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tenantDo) FirstOrInit() (*po.Tenant, error) {
...
func (t tenantDo) FirstOrCreate() (*po.Tenant, error) {
...
func (t tenantDo) FindByPage(offset int, limit int) (result []*po.Tenant, count int64, err error) {
...
func (t tenantDo) Delete(models ...*po.Tenant) (result gen.ResultInfo, err error) {
