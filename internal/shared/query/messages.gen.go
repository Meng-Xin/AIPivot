...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.TokenCount = field.NewInt(tableName, "token_count")
...
func (m *message) updateTableName(table string) *message {
	...
	m.TokenCount = field.NewInt(table, "token_count")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["token_count"] = m.TokenCount
...
type IMessageDo interface {
	...
	Unscoped() IMessageDo
	Create(values ...*po.Message) error
	CreateInBatches(values []*po.Message, batchSize int) error
	Save(values ...*po.Message) error
	First() (*po.Message, error)
	Take() (*po.Message, error)
	Last() (*po.Message, error)
	Find() ([]*po.Message, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Message, err error)
	FindInBatches(result *[]*po.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po.Message) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po.Message, error)
	FirstOrCreate() (*po.Message, error)
	FindByPage(offset int, limit int) (result []*po.Message, count int64, err error)
...
func (m messageDo) Create(values ...*po.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) CreateInBatches(values []*po.Message, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m messageDo) Save(values ...*po.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) First() (*po.Message, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po.Message), nil
	}
}

func (m messageDo) Take() (*po.Message, error) {
...
func (m messageDo) Last() (*po.Message, error) {
...
func (m messageDo) Find() ([]*po.Message, error) {
	result, err := m.DO.Find()
	return result.([]*po.Message), err
}

func (m messageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Message, err error) {
	buf := make([]*po.Message, 0, batchSize)
...
func (m messageDo) FindInBatches(result *[]*po.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m messageDo) FirstOrInit() (*po.Message, error) {
...
func (m messageDo) FirstOrCreate() (*po.Message, error) {
...
func (m messageDo) FindByPage(offset int, limit int) (result []*po.Message, count int64, err error) {
...
func (m messageDo) Delete(models ...*po.Message) (result gen.ResultInfo, err error) {
